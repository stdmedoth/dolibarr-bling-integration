...
/**
 * \file    test/phpunit/BlingFunctionalTest.php
 * \ingroup bling
 ...
 * @package Testbling
 */
class BlingFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/bling/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('bling/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/bling/admin/about.php');
		$this->authenticate();
		return $this->assertContains('bling/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('blingwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBling_BlingTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBling_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
